        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('genders.create') }}" class="btn btn-primary px-5">Criar Genero</a>
                        <div class="table-responsive custom-scrollbar">
                            <table class="display table-striped border" id="basic-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $gender->name }}</td>
                                        <td>{!! is_enabled($gender->is_enabled) !!}</td>
                                        <td>{{ $gender->created_at }}</td>
                                        <td>
                                            <ul class="action">
                                                <li class="edit">
                                                    <a href="{{ route('genders.edit', $gender->id) }}"><i class="fa-regular fa-pen-to-square"></i></a>
                                                </li>
                                                <li class="delete">
